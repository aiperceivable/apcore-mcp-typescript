...
export class TransportManager {
  ...
  /**
   * Create a Streamable HTTP request handler that dispatches to builtins,
   * auth, explorer, and the MCP transport endpoint.
   *
   * Shared by runStreamableHttp() and buildStreamableHttpApp() to avoid
   * duplicating the ~50-line handler logic.
   */
